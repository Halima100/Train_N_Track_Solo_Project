...
If you would like to name your database something else, you will need to change `TNT_app` to the name of your new database name in `server/modules/pool.js`
